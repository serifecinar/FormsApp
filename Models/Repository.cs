namespace FormsApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product{ProductId=3, Name="İphone 14",Price=60000,IsActive=true, Image="3.jpg",CategoryId=1});
            _products.Add(new Product{ProductId=4, Name="İphone 14",Price=70000,IsActive=true, Image="4.jpg",CategoryId=1});
